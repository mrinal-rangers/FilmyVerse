...
const Card = ({e,i}) => {
  return (
    <div key={i} className='card mr-6 shadow-lg p-2 hover:-translate-y-4 cursor-pointer mt-5 mb-5 md:mt-3 transition-all duration-500'>
        <img className=" md:h-80  xs:h-36 mb-2 border-2"src={e.image} alt="img"/>
        <h1><span className='text-red-500'>Title :</span> {e.title}</h1>
